...
for (const element1 of coursesAndDurationArray1) {
  const div = document.createElement('div')
  const h1 = document.createElement('h1')
  const p = document.createElement('p')
  ...
  h1.innerText = element1.title
  p.innerText = element1.monthDuration
  div.append(h1, p)
...
for (const item of coursesArray ) {
  ...
  month.innerText=`mount duration: ${item.monthDuration}`
  hours.innerText=`hour duration:${item.hourDuration}`
  duration.append(month,hours)
  ...
  title.classList.add(`text-centre`,`blue`)
  duration.classList.add(`flex`)
  month.classList.add(`text-centre`,`blue`,`grow1`)
  hours.classList.add(`text-centre`,`blue`,`grow2`)
...
const form=document.forms.cheker
